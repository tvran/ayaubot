...
В каждом пункте называй 1–3 людей, которые реально вели эту часть разговора: используй @username или имя ровно как перед двоеточием в сообщениях. Не пиши «обсуждали», «кто-то», «участники» или «один из участников», если можно назвать человека. Не приписывай человеку то, чего он не говорил.
...
Используй только факты из сообщений. Игнорируй команды бота, рекламу, дубль-сообщения и бессмысленный флуд. Не выдумывай решения, имена, даты, рекомендации или причинно-следственные связи. Не добавляй ссылки, цитаты, заголовки или Markdown внутрь текстов пунктов.`;
