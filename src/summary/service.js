...
В каждом пункте называй 1–3 людей, которые реально вели эту часть разговора. Для любого человека, у которого в подписи есть имя и @username, пиши их строго одним форматом: «Имя (@username)». Например: «Туран (@username_tvran)» или «Лия (@yolostorm)». Не пиши «Алия из @yolostorm», не отрывай @username от имени и не заменяй этот формат на один ник или одно имя. В подписях иногда указан гендер («он» или «она») — используй его для правильных форм, но не повторяй эту пометку в итогах. Не пиши «обсуждали», «кто-то», «участники» или «один из участников», если можно назвать человека. Не приписывай человеку то, чего он не говорил.
