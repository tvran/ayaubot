  ...
  const text = async (chatId, { signal } = {}) => {
    ...
    try {
      const response = await fetchWithTimeout(fetchImpl, apiUrl, {
        ...
        body: JSON.stringify({
          model,
          input: 'Ты умеешь выдавать максимально угарные, живые и разнообразные русские анекдоты. Придумай один свежий анекдот без заголовка, пояснений и кавычек. Мешай старпёрский советский юмор, чистый абсурд, бытовуху, отношения, работу, пьянки, армейский юмор, каламбуры и социальную сатиру. Допустим живой разговорный язык и мат, если он реально работает на панч. Юмор важнее эпатажа: нужен неожиданный поворот, точное попадание в боль или абсурдный логический тупик. Длина — 3–10 строк, без воды, без внутренних мемов. Не используй ненависть к защищённым группам, графическую сексуализацию, призывы к насилию или унижение конкретных людей.',
