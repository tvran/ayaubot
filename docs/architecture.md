...
`/demotivation <текст>` требует reply на фото, image-document или статический стикер. Bot App скачивает Telegram-файл, renderer применяет EXIF-ориентацию и растягивает всё изображение до внутренней области 908×876 без обрезки. Satori строит чёрный шаблон 1084×1200 с белой рамкой и адаптивной подписью, Sharp объединяет слои и возвращает JPEG для `sendPhoto`.
