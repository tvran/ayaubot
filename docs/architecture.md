...
7. `/q`, `/qs` и `/qd` направляются в подсистему цитат; `/percent` — в Percent Game; `/all` — в подсистему упоминаний; команды дней рождения — в Birthday Service; остальные известные команды — в аналитику.
