...
AyauBot — Telegram-бот для групповых чатов. Он превращает сообщения в статические WebP-стикеры, скачивает Instagram Reels и TikTok-видео, зовёт известных участников чата, ведёт статистику слов, запускает игры, напоминает о днях рождения и ежедневно выбирает случайного участника чата.
