...
AyauBot — Telegram-бот для групповых чатов. Он превращает сообщения в статические WebP-стикеры, скачивает Instagram Reels и TikTok-видео, ведёт статистику слов, запускает игру с кодовым словом и ежедневно выбирает случайного участника чата.
