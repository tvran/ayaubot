...
| [Монитор кино Ticketon](components/kino-monitor.md) | Inline-выбор фильмов/кинотеатров, публичные карты мест и часовой scheduler |
...
| `/kino` | Настроить фильмы, кинотеатры, время и число соседних мест для утреннего дайджеста |
